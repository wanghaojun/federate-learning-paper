...
随着数据孤岛的出现和隐私意识的普及，传统的集中训练人工智能模型的方法面临着强烈的挑战，联邦学习(FL)则是一个很有前途的解决方案。现有的FL协议设计已经显示出可以被系统内外的对手利用的漏洞，从而危及数据隐私。因此，最重要的是让FL系统设计者意识到未来FL算法设计对隐私保护的影响。在本文中，我们填补了这一重要空白的FL文献。通过简要介绍FL的概念，以及一个涵盖威胁模型和FL的两个主要攻击：1）中毒攻击和2）推理攻击的独特分类法，本文对这一重要主题进行了一次回顾，我们强调了直觉、关键技术以及各种攻击所采用的基本假设，并讨论了未来在FL中更健壮的隐私保护方面的研究方向。
...
![](http://img.wanghaojun.cn//img/20201215180737.png)